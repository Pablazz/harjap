...
if ($selected_user) {
    ...
    $total_query = $conn->prepare("SELECT COUNT(*) as total FROM pdf_files WHERE user_email = ?");
    ...
    // Fetch Excel files
    $file_query = $conn->prepare("SELECT id, file_name FROM pdf_files WHERE user_email = ? LIMIT ?, ?");
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <h3 class="text-center text-primary">Delete Credit Notes</h3>
