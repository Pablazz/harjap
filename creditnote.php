...
$stmt = $conn->prepare("SELECT * FROM pdf_files WHERE user_email = ?  LIMIT ? OFFSET ?");
...
$count_stmt = $conn->prepare("SELECT COUNT(*) AS total FROM pdf_files WHERE user_email = ?");
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $result->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="uploads/pdf/<?php echo htmlspecialchars($row['file_name']); ?>" download>
