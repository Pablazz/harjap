...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_stmt->num_rows > 0) {
        $_SESSION['error_message'] = "⚠️ User already exists!";
        header("Location: add_user.php");
        exit();
    }
    $check_stmt->close();
    ...
    $sql = "INSERT INTO users (email, password, label_name) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sss", $email, $hashed_password, $label_name);
                    ...
                    <form action="" method="post">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <span class="nav-item nav-link">@pixildigi.com</span>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="lable_name" class="form-label">Label Name</label>
